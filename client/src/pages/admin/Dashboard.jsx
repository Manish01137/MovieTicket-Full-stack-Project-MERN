import { CircleDollarSignIcon, StarIcon, UsersIcon, UserIcon, TrendingUpIcon } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const dashboradCards = [
    { title: "Total Bookings", value: dashboardData.totalBookings || "0", icon: TrendingUpIcon },
