import { CircleDollarSignIcon, SquareBottomDashedScissors, StarIcon, UsersIcon } from 'lucide-react';
  ...
  return !loading ?(
       ...
       <Title text1="Admin" text2="Dashboard"/>
        <div className="relative flex flex-wrap gap-4 mt-6">
          ...
          <div className="relative flext flex-wrap gap-6 mt-4 max-w-5xl">
            ...
            {dashboardData.activeShows.map((show))=>(
              ...
              hover:-translate-y-1 transition duration-300">
                <img src={show.movie.poster_path} alt="" className="h-60 w-full
                object-cover" />
